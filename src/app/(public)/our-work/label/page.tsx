...
export default async function LabelPage() {
  ...
  return (
    <>
      ...
      <section className="py-20 px-6 lg:px-10">
        <AnimateIn className="max-w-[800px] mx-auto text-center">
          ...
          <p className="text-lg text-body leading-relaxed max-w-lg mx-auto">
            Custom labels designed for shelf impact—foil stamping, embossing, and
            specialty substrates that communicate your brand essence at first
            glance.
          </p>
        </AnimateIn>
      </section>
      ...
      <CtaBand
        title="Need Custom Labels?"
        description="From wine bottles to skincare, we design labels that make your product stand out on any shelf."
